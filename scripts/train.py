...
def main(args):
    ...
    processor = CLIPProcessor.from_pretrained("/mnt/d/model/clip-vit-large-patch14") #TODO
    vision_tower_model = CLIPModel.from_pretrained("/mnt/d/model/clip-vit-large-patch14") #TODO
...
if __name__ == "__main__":
    config_dic = {
        ...
        'output_dir': '/mnt/d/code/EmoEdit-official/train_data/test',
        'num_embedding': 77,
        'batch_size': 32,
    } #TODO
